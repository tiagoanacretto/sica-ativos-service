...
//        AgendamentoManutencaoAtivo ultimoAgendamento = agendamentoManutencaoAtivoRepository.findTopByAtivoIdAndStatusOrderByDataRealizadaDesc(12345L, StatusAgendamento.REALIZADA);
//
...
//
//        AgendamentoManutencaoAtivo ultimoAgendamento = agendamentoManutencaoAtivoRepository.findTopByAtivoIdAndStatusOrderByDataRealizadaDesc(ativo.getId(), StatusAgendamento.REALIZADA);
//
//        assertEquals(null, ultimoAgendamento);
//    }
...
//    }
    ...
    private Ativo mockAtivo_cenario2() {
        ...
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.AGENDADA, UM_DIA_FRENTE.toLocalDate(), null));
    ...
    private Ativo mockAtivo_cenario3() {
        ...
        ativo.setDataCadastro(new DateTime());
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.REALIZADA, DOIS_DIAS_ATRAS.toLocalDate(), DOIS_DIAS_ATRAS));
        return ativoRepository.save(ativo);
    }
    ...
    private Ativo mockAtivo_cenario4() {
        ...
        ativo.setDataCadastro(new DateTime());
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.CANCELADA, UM_DIA_FRENTE.toLocalDate(), DOIS_DIAS_ATRAS));
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.REALIZADA, DOIS_DIAS_ATRAS.toLocalDate(), DOIS_DIAS_ATRAS));
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.REALIZADA, UM_DIA_ATRAS.toLocalDate(), UM_DIA_ATRAS));
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.AGENDADA, UM_DIA_FRENTE.toLocalDate(), null));
        ativo.addAgendamento(mockAgendamentoManutencaoAtivo(StatusAgendamento.REALIZADA, DOIS_DIAS_ATRAS.toLocalDate(), DOIS_DIAS_ATRAS));
        return ativoRepository.save(ativo);
    }

    private AgendamentoManutencaoAtivo mockAgendamentoManutencaoAtivo(StatusAgendamento status, LocalDate dataAgendada, DateTime dataRealizada) {
